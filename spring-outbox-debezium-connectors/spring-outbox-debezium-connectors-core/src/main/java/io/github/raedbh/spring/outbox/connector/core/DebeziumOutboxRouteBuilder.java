 ...
 * them as {@link OutboxData} messages to brokers.
 *
 * @author Raed Ben Hamouda
 * @since 1.0
 */
public class DebeziumOutboxRouteBuilder extends RouteBuilder {

    private static final Logger LOGGER = LoggerFactory.getLogger(DebeziumOutboxRouteBuilder.class);

    private final String camelComponentUri;
    private final OutboxMessageProducer messageProducer;


    public DebeziumOutboxRouteBuilder(OutboxMessageProducer messageProducer, String camelComponentUri) {
