...
. **Add dependencies** +
Include the following dependency in your E-commerce Spring Boot application along with Spring starters such as `spring-boot-starter-data-jpa` and `spring-boot-starter-web`:
+
[source, xml]
----
