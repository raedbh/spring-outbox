...
. **Add Spring Outbox Dependencies**: add the necessary Spring Outbox dependencies to our _E-commerce_ Spring Boot application. Here’s an example of the required dependencies when using JPA and RabbitMQ as the message broker:
+
[source, xml]
----
