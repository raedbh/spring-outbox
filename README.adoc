...
- Download the connector from Maven Central: https://repo1.maven.org/maven2/io/github/raedbh/spring-outbox-debezium-connector-mysql-rabbit/0.1.0/spring-outbox-debezium-connector-mysql-rabbit-0.1.0.jar[spring-outbox-debezium-connector-mysql-rabbit-0.1.0.jar]
